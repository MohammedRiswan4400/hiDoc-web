...
//
//     final hiDocWeb = hiDocWebFromJson(jsonString);

import 'dart:convert';

HiDocWeb hiDocWebFromJson(String str) => HiDocWeb.fromJson(json.decode(str));

String hiDocWebToJson(HiDocWeb data) => json.encode(data.toJson());
...
class HiDocWeb {
  ...
  factory HiDocWeb.fromJson(Map<String, dynamic> json) => HiDocWeb(
